    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font text-gray-500 uppercase tracking-widest"><nuxt-link :to="{name: 'shop-brands-slug',params: {'slug' : product.Brand.slug}}">{{ product.Brand.name }}</nuxt-link></h2>
          ...
          <div class="flex">
            <span v-if="product.sale_price == 0" class="title-font font-medium text-2xl text-gray-900 pr-2">${{ product.price }}</span>
            <span v-if="product.sale_price > 0" class="title-font font-medium line-through text-2xl text-red-400 pr-2">${{ product.price }}</span>
            <span v-if="product.sale_price > 0" class="title-font font-medium text-2xl text-gray-900">${{ product.sale_price }}</span>
